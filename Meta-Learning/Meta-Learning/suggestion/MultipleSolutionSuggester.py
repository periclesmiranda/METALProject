...
from dominance.DominanceEvaluator import DominanceEvaluator
from suggestion.SolutionGenerator import SolutionGenerator
import math

class MultipleSolutionSuggester(SolutionSuggester):
    ...
    def generate_suggestions(self, feature, dbs_per_features, dbs_per_operators, n_suggestions, n_problems=None):
        ...
        filtered_ops = self._suggest(feature[1:], current_features, current_operators, len(feature[1:]), ["max","min"], n_suggestions, n_problems);
    ...
    def _suggest_operators(self, features, operators_table, problems, n_suggestions, n_problems):
        ...
        for i in range(0, len(features)):
            ...
            operators = DominanceEvaluator.verifyDominanceUsingCrowdingDistance(filtered_operators, problems)
